    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wide mb-3">개요</h3>
          ...
          {prd.requirements.map((req) => (
            ...
            >
              ...
              {req.acceptanceCriteria.length > 0 && (
                <div>
                  <p className="text-xs text-gray-500 uppercase tracking-wide mb-2">인수 조건</p>
